...
errors-addons-active-popup =
    ...
    An error occurred. Please start Kelma while holding down the shift key,
    ...
    Tools > Add-ons menu item to disable some add-ons and restart Kelma,
...
errors-accessing-db =
    ...
    interfering with Kelma. Try disabling such software and see if the
    problem goes away.
    - Your disk may be full.
    - The Documents/Kelma folder may be on a network drive.
    - Files in the Documents/Kelma folder may not be writeable.
    - Your hard disk may have errors.
    
    It's a good idea to run Tools>Check Database to ensure your collection is not corrupt.
errors-unable-open-collection =
    Kelma was unable to open your collection file. If problems persist after restarting your computer, please use the Open Backup button in the profile manager.
