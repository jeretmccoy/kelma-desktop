...
launcher-press-enter-to-install = Press the Enter/Return key on your keyboard to install or update Kelma.
launcher-press-enter-to-start = Press enter to start Kelma.
launcher-anki-will-start-shortly = Kelma will start shortly.
launcher-you-can-close-this-window = You can close this window.
launcher-updating-anki = Updating Kelma...
launcher-latest-anki = Install Latest Kelma (default)
...
launcher-uninstall = Uninstall Kelma
...
launcher-uninstall-confirm = Uninstall Kelma's program files? (y/n)
