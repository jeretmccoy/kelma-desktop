...
preferences-changes-will-take-effect-when-you = Changes will take effect when you restart Kelma.
...
preferences-media-is-not-backed-up = Media is not backed up. Please create a periodic backup of your Kelma folder to be safe.
...
preferences-please-restart-anki-to-complete-language = Please restart Kelma to complete language change.
...
preferences-some-settings-will-take-effect-after = Some settings will take effect after you restart Kelma.
...
preferences-backup-explanation =
    Kelma periodically backs up your collection. After backups are more than 2 days old,
    Kelma will start removing some of them to free up disk space.
